...
class Directory(jose.JSONDeSerializable):
	...
	#Added for STAR
	#star_certs_supported = jose.Field('star-certs-supported', omitempty=True)
	#min_recurrent_certificate_validity = jose.Field('min-recurrent-certificate-validity', omitempty=True)
	#max_recurrent_renewal_period = jose.Field('max-recurrent-renewal-period', omitempty=True)
    @classmethod
...
class RegistrationResource(ResourceWithURI):
    ...
    """
    #print('LOG from messages.py:')
    body = jose.Field('body', decoder=Registration.from_json)
    new_authzr_uri = jose.Field('new_authzr_uri', omitempty=True)
    terms_of_service = jose.Field('terms_of_service', omitempty=True)
    #star_certs_supported = jose.Field('star-certs-supported', omitempty=False)
